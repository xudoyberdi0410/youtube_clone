    ...
    <div className="max-w-[96rem] mx-auto px-4 sm:px-6 py-8 space-y-10 bg-background min-h-screen">
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          <h2 className="text-xl sm:text-2xl font-semibold tracking-tight">История</h2>
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          <h2 className="text-xl sm:text-2xl font-semibold tracking-tight">Понравившиеся</h2>
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          <h2 className="text-xl sm:text-2xl font-semibold tracking-tight">Плейлисты</h2>
        ...
        <div className="flex gap-4 overflow-x-auto pb-2">
          {playlists.length
            ...
            : Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="w-56 h-32 bg-muted rounded-lg animate-pulse" />
              ))}
        </div>
      </section>
    </div>
